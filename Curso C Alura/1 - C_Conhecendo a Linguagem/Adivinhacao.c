...
int main() {
    //ascii art feita com https://www.ascii-art-generator.org/ 
    ...
    srand(time(0));
    int numerosecreto = rand() % 100;// numero entre 0 e 99
    ...
    for(int i = 1; i <= totaldetentativas; i++) {
        ...
        double pontosperdidos = abs(chute - numerosecreto) / 2.0;//or (double) 2.0 to convert to double
    ...
    if(acertou) {
        ...
        printf("Você fez %.2f pontos. Até a próxima!\n\n", pontos);//.2f para formatar com 2 casas decimais
    } else {
